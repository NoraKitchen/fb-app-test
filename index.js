...
//The session stores the fbid of the user the conversation belongs to, and the Wit context object built through the conversation
//Session will be deleted when user makes a successful search
var sessions = {};
